<article class="flex-1">
	...
	<div class="flex-row margin-bottom double-unit-layout">
		<div class="columns-4">
			...
			<div class="columns-8">
				<h4>Mathilde Leo</h4>
				<p>Product Owner. Martial arts aficionado.</p>
				<a target="_blank" href="http://uk.linkedin.com/in/mathildeleo">LinkedIn</a>
	...
	<div class="flex-row">
		<div class="columns-4">
			<img src="../../assets/images/team/slavo-vojacek.png">
		</div>
			<div class="columns-8">
				<h4>Slavo Vojacek</h4>
